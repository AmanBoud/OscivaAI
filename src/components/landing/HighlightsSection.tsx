          ...
          {reasons.map((r, i) => (
            <Reveal key={r.title} i={i}>
              <div className="group h-full rounded-2xl border border-[#EBEDF0] bg-white p-6 transition-all duration-300 hover:border-[#0EC2A8]/30 hover:shadow-premium hover:-translate-y-1">
                <div className="w-12 h-12 rounded-xl bg-[#F7F8FA] border border-[#EBEDF0] flex items-center justify-center mb-5 transition-colors group-hover:bg-[#FFF1EC] group-hover:border-[#0EC2A8]/20">
                  <r.icon size={21} className="text-[#0B0E14] transition-colors group-hover:text-[#0EC2A8]" />
                </div>
